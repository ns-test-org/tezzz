      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border border-white/20">
        <div className="w-80">
          ...
          <div className="bg-black/20 rounded-lg p-4 mb-4 border border-white/10">
            <div className="text-right text-white text-3xl font-mono min-h-[2.5rem] flex items-center justify-end overflow-hidden">
              {display}
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            <Button
              ...
              className="row-span-2 bg-green-500/80 hover:bg-green-500 text-white"
            >
              =
            </Button>
            ...
            <Button
              ...
              className="col-span-2 bg-gray-700/80 hover:bg-gray-600 text-white"
            >
              0
            </Button>
            <Button
          ...
          <div className="text-center mt-4">
            <h1 className="text-white/80 text-sm font-medium">Simple Calculator</h1>
          </div>
        </div>
      </div>
    </div>
